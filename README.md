...
- Starters include:
  ...
  - initial get function in [app.js](https://github.com/nameer-rizvi/ssr_boilerplate/blob/master/src/react/components/app.js) to fetch data (via axios) from the api endpoint; and,
